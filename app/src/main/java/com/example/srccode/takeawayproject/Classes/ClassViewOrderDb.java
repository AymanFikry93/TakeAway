...
public class ClassViewOrderDb extends Model {
    //
    @Column(name = "orderid")
    ...
    public ClassViewOrderDb( ) {}

    public ClassViewOrderDb(String orderid, String Ordername, String Orderprice ,String Orderimage,String Orderquantity
